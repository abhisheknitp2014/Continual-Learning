...
# run_exp3_ewc_from_t0_permu(rClassD2List=cl_auth_class_task2_c10,rDataset=args.rDataset,
#     rEpoch=args.rEpoch,cuda_num=args.cuda_num,exp_setup=args.exp_setup,
#     max_num_cases=args.max_num_cases,fisher_n=args.fisher_n,
#     cb_test_metric=args.cb_test_metric,bm_on=args.bm_on,th=args.th)

if args.rExp < 3:
    run_exp12_ewc(rClassD2List=rev_get_class_D2_list(args),rDataset=args.rDataset,
        rMeasureType=args.rMeasureType,rEpoch=args.rEpoch,cuda_num=args.cuda_num,exp_type=None,
        subject_idx=args.subject_idx,exp_setup=args.exp_setup,fisher_n=args.fisher_n,
        n_layers=args.n_layers,n_units=args.n_units,lr2=args.lr2,batch_size=args.batch_size,trial=args.trial)
elif args.rExp == 3:
    run_exp3_ewc_from_t0_permu(rClassD2List=rev_get_class_D2_list(args),rDataset=args.rDataset,
        rMeasureType=args.rMeasureType,rEpoch=args.rEpoch,cuda_num=args.cuda_num,exp_type=None,
        subject_idx=args.subject_idx,exp_setup=args.exp_setup,max_num_cases=args.max_num_cases,fisher_n=args.fisher_n,
        n_layers=args.n_layers,n_units=args.n_units,lr2=args.lr2,batch_size=args.batch_size,trial=args.trial)
else: 
	run_exp3_ewc_online_from_t0_permu(rClassD2List=rev_get_class_D2_list(args),rDataset=args.rDataset,
        rMeasureType=args.rMeasureType,rEpoch=args.rEpoch,cuda_num=args.cuda_num,exp_type=None,
        subject_idx=args.subject_idx,exp_setup=args.exp_setup,max_num_cases=args.max_num_cases,fisher_n=args.fisher_n,
        n_layers=args.n_layers,n_units=args.n_units,lr2=args.lr2,batch_size=args.batch_size,trial=args.trial)
