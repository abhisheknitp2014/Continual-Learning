...
if args.rExp < 3:
    run_exp12_lwf(rClassD2List=rev_get_class_D2_list(args),rDataset=args.rDataset,
    ...
    run_exp3_lwf_from_t0_permu(rClassD2List=rev_get_class_D2_list(args),rDataset=args.rDataset,
        rMeasureType=args.rMeasureType,rEpoch=args.rEpoch,cuda_num=args.cuda_num,exp_type=None,
