...
def _eval_cb(log, test_datasets, visdom=None, precision_dict=None, iters_per_task=None,
             test_size=None, classes_per_task=None, scenario="class", num_classes_per_task_l=None, experiment=None,
             summary_graph=True, with_exemplars=False):
    ...
    def eval_cb(classifier, batch, task=1, args=None):
        ...
        if iteration % log == 0:
            evaluate.precision(classifier, test_datasets, task, iteration,
                               ...
                               num_classes_per_task_l=num_classes_per_task_l, experiment=experiment,
                               summary_graph=summary_graph,with_exemplars=with_exemplars, args=args)
...
def _solver_loss_cb(log, visdom, model=None, tasks=None, iters_per_task=None, replay=False, progress_bar=False):
